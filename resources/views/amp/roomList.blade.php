...
<div class="container-fluid game px-0">
  <div class="container p-3">
    ...
    <p class="w-100 text-center my-1">
      <a style="color: white" id="tao-phong" data-phong="<?php echo md5(time()); ?>" data-url="{{ url('/amp') }}/phong/<?php echo md5(time()); ?>" class="btn btn-success btn-lg pulse"><i class="fad fa-plus-circle"></i> Tạo phòng mới</a>
    </p>
  ...
  @for ($i = 0; $i < count($rooms); ++$i)
          <tr>
            ...
            <td class="text-center" data-sort-method="none"><a style="color: white" target="_blank" class="btn btn-danger" href="{{ url('/amp') }}/phong/{{ $rooms[$i]['code'] }}/do">ĐỎ</a></td>
            <td class="text-center" data-sort-method="none"><a style="color: white" target="_blank" class="btn btn-dark" href="{{ url('/amp') }}/phong/{{ $rooms[$i]['code'] }}/den">ĐEN</a></td>
            <td class="text-center" data-sort-method="none"><a style="color: white" target="_blank" class="btn btn-success" href="{{ url('/amp/chia-se/') }}/{{ $rooms[$i]['fen'] }}">Xem</a></td>
