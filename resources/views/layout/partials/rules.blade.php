  ...
  <div class="container p-3 lead">
    ...
    <div class="row font-weight-bold">
      ...
      <ol>
        ...
        <li><u>Chơi với máy:</u> Kì thủ <strong><em>chơi cờ tướng với máy</em></strong> ngay trên trang chủ. Có 4 cấp độ: <a target="_blank" href="{{ url('/moi-choi') }}">Mới chơi</a>, <a target="_blank" href="{{ url('/de') }}">Dễ</a>, <a target="_blank" href="{{ url('/binh-thuong') }}">Bình thường</a>, <a target="_blank" href="{{ url('/kho') }}">Khó</a>.</li>
        ...
        <li><u>Cờ thế:</u> Dành cho các kỳ thủ, người đã biết chơi cờ lão luyện. Kỳ thủ ấn vào nút <a target="_blank" href="{{ url('/co-the') }}">"Cờ thế"</a> trên trang chủ, sau đó di chuyển và bày trận theo ý của mình, nhấn nút "CHỤP BÀN CỜ THẾ" và mời bạn bè cùng giải cờ thế.</li>
      </ol>
    </div>
  </div>
</div>