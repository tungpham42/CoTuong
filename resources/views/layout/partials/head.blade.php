<title>{{ $headTitle }} - Chơi cờ tướng với máy - Choi co tuong voi may</title>
...
<meta property="og:title" content="{{ $headTitle }} - Chơi cờ tướng với máy - Choi co tuong voi may" />
...
<link rel="stylesheet" href="{{ URL::to('/') }}/css/fa/css/in-use.css" />
...
<link rel="alternate" hreflang="vi" href="{{ URL::to('/').$canonicalUrl }}"/>
<link rel="alternate" hreflang="en" href="{{ URL::to('/').$langUrl }}"/>
<!-- <link rel="amphtml" href="{{ URL::to('/') }}/amp{{ $canonicalUrl }}" /> -->
