...
<p class="w-100 text-center mt-4">
  <a id="new-board" class="w-25 btn btn-warning btn-lg"><i class="fad fa-plus-circle"></i> New board</a>
  <a id="clear" class="w-25 btn btn-danger btn-lg"><i class="fad fa-redo-alt"></i> Clear</a>
</p>
