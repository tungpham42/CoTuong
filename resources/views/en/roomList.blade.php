...
<div class="container-fluid game px-0">
  <div class="container p-3">
    ...
    <p class="w-100 text-center my-1">
      <a id="tao-phong" data-phong="<?php echo md5(time()); ?>" data-url="{{ url('/') }}/room/<?php echo md5(time()); ?>" class="btn btn-success btn-lg pulse"><i class="fad fa-plus-circle"></i> Host a room</a>
    </p>
  ...
  @for ($i = 0; $i < count($rooms); ++$i)
          <tr>
            ...
            <td class="text-left"><a href="{{ url('/') }}/room/{{ $rooms[$i]['code'] }}">{{ $rooms[$i]['code'] }}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-key text-danger" data-toggle="tooltip" data-placement="bottom" data-original-title="{{ $rooms[$i]['pass'] }}"></i></td>
            ...
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-danger" href="{{ url('/') }}/room/{{ $rooms[$i]['code'] }}/red">RED</a></td>
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-dark" href="{{ url('/') }}/room/{{ $rooms[$i]['code'] }}/black">BLACK</a></td>
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-success" href="{{ url('/share/') }}/{{ $rooms[$i]['fen'] }}">View</a></td>
