...
<div class="container-fluid game px-0">
  <div class="container p-3">
    ...
    <p class="w-100 text-center my-1">
      <a id="tao-phong" data-phong="<?php echo md5(time()); ?>" data-url="{{ url('/') }}/phong/<?php echo md5(time()); ?>" class="btn btn-success btn-lg pulse"><i class="fad fa-plus-circle"></i> Tạo phòng mới</a>
    </p>
  ...
  @for ($i = 0; $i < count($rooms); ++$i)
          <tr>
            ...
            <td class="text-left"><a href="{{ url('/') }}/phong/{{ $rooms[$i]['code'] }}">{{ $rooms[$i]['code'] }}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-key text-danger" data-toggle="tooltip" data-placement="bottom" data-original-title="{{ $rooms[$i]['pass'] }}"></i></td>
            ...
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-danger" href="{{ url('/') }}/phong/{{ $rooms[$i]['code'] }}/do">ĐỎ</a></td>
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-dark" href="{{ url('/') }}/phong/{{ $rooms[$i]['code'] }}/den">ĐEN</a></td>
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-success" href="{{ url('/chia-se/') }}/{{ $rooms[$i]['fen'] }}">Xem</a></td>
